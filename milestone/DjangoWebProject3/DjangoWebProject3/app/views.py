...
#from DjangoWebProject3.settings import *
from os import path
...
def watch(request):
    if request.method =='GET':
        ...
        return render(request, 'app/watch.html',{'form':form,'comm':c,'bold':"mickey",'track':path.dirname(path.dirname(path.abspath(__file__)))})
